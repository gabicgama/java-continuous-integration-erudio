...
public class PersonControllerTest {
	...
	public void setup() {
		// Given / Arrange
		person = new Person("Leandro", "Costa", "Uberlândia - Minas Gerais - Brasil", "Male", "leandro@erudio.com.br");
	}
	...
	void testGivenListOfPersons_WhenFindAllPersons_thenReturnPersonsList() throws Exception {
		...
		persons.add(person);
		persons.add(new Person("Leonardo", "Costa", "leonardo@erudio.com.br", "Uberlândia - Minas Gerais - Brasil",
				"Male"));
	...
	void testGivenUpdatedPerson_WhenUpdate_thenReturnUpdatedPersonObject() throws Exception {
		...
		// When / Act
		Person updatedPerson = new Person("Leonardo", "Costa", "Uberlândia - Minas Gerais - Brasil", "Male",
